...
export default async function EsewaPaymentPage({
  searchParams,
}: {
    ...
    <Container className="py-16">
      <div className="mx-auto max-w-2xl rounded-2xl border border-line bg-card p-8 text-center">
        ...
        <p className="mt-4 text-muted">
          Order {orderId.slice(0, 8)} is ready for eSewa checkout for{" "}
          {formatNPR(amount)}. Add merchant credentials, signature creation, and
          callback verification before enabling live capture.
        </p>
