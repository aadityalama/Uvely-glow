...
export function CustomerReviewsSection() {
  return (
    <section className="border-t border-line bg-blush/35 py-16 sm:py-24">
      <div className="mx-auto max-w-[88rem] px-5 sm:px-8 lg:px-12">
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="mt-3 max-w-xl font-display text-3xl font-medium text-deep sm:text-4xl md:text-5xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3 md:gap-8">
          {REVIEWS.map((r) => (
            <blockquote
              key={r.name}
              className="flex flex-col rounded-3xl border border-line/90 bg-card p-6 shadow-sm sm:p-8"
            >
              ...
              <p className="mt-5 text-sm leading-relaxed text-muted sm:text-base">&ldquo;{r.quote}&rdquo;</p>
            </blockquote>
          ))}
        </div>
      </div>
